...
public class ControllerAdvice {
    ...
    public ResponseEntity<Object> catchIOException(final IOException ex) {
        BaseErrorResponse response = new BaseErrorResponse(HttpStatus.EXPECTATION_FAILED.value(), ErrorType.UNKNOWN_EMAIL_SERVICE_ERROR, ex.getMessage());
    ...
    public ResponseEntity<Object> catchDataIntegrityViolationException(final DataIntegrityViolationException ex) {
        ex.printStackTrace();
        BaseErrorResponse response = new BaseErrorResponse(HttpStatus.NOT_ACCEPTABLE.value(), ErrorType.UNKNOWN_EMAIL_SERVICE_ERROR, ex.getMessage());
        return new ResponseEntity<>(response, HttpStatus.NOT_ACCEPTABLE);
    }

    @ExceptionHandler(IllegalArgumentException.class)
    public ResponseEntity<Object> handleIllegalArgumentException(final IllegalArgumentException ex) {
        BaseErrorResponse response = new BaseErrorResponse(HttpStatus.BAD_REQUEST.value(), ErrorType.UNKNOWN_EMAIL_SERVICE_ERROR, ex.getMessage());
    ...
    public ResponseEntity<Object> handleIllegalStateException(final IllegalStateException ex) {
        BaseErrorResponse response = new BaseErrorResponse(HttpStatus.SERVICE_UNAVAILABLE.value(), ErrorType.UNKNOWN_EMAIL_SERVICE_ERROR, ex.getMessage());
    ...
    public ResponseEntity<BaseErrorResponse> handleInvocationTargetException(final InvocationTargetException ex) {
        BaseErrorResponse response = new BaseErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR.value(), ErrorType.UNKNOWN_EMAIL_SERVICE_ERROR, ex.getMessage());
    ...
    public ResponseEntity<BaseErrorResponse> handleTransactionSystemException(final TransactionSystemException ex) {
        ...
        BaseErrorResponse response = new BaseErrorResponse(HttpStatus.BAD_REQUEST.value(), ErrorType.UNKNOWN_EMAIL_SERVICE_ERROR, errorMessage);
        return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(EmailServiceException.class)
    public ResponseEntity<BaseErrorResponse> handleInsuranceServiceException(final EmailServiceException ex) {
